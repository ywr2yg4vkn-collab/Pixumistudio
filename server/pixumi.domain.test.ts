...
import { countMatrix, nextVersion, processingMessageForElapsed, validateProduction } from "../shared/pixumi";
...
describe("Pixumi domain rules", () => {
  ...
  it("shows truthful feedback as a long-running process advances", () => {
    expect(processingMessageForElapsed(0)).toContain("Iniciando");
    expect(processingMessageForElapsed(12)).toContain("continua ativa");
    expect(processingMessageForElapsed(45)).toContain("Ainda trabalhando");
  });
